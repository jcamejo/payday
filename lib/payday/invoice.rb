module Payday
  ...
  class Invoice
    ...
    attr_accessor :invoice_number, :bill_to, :ship_to, :notes, :line_items, :shipping_rate, :shipping_description,
      :tax_rate, :tax_description, :due_at, :paid_at, :refunded_at, :currency, :invoice_details, :invoice_date, :discount, :invoice_type
    ...
    def initialize(options =  {})
      ...
      self.discount = options[:discount] || nil
      self.invoice_type = options[:invoice_type] || nil
    end
